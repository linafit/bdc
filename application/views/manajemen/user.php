<div class="container-fluid my-3">
    <div class="card border-0">
        <div class="card-body">
            <h5 class="text-capitalize fw-bold mb-5" style="color: #012970;">Manajemen User</h5>
            <table class="table myTable compact " id="myTable">
                <thead >
                    <tr>
                        ...
                        <th scope="col">Terakhir Dikontak</th>
                        <th scope="col">Level Prospek</th>
